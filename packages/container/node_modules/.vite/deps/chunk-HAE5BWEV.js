...
// node_modules/.pnpm/highcharts@9.3.3/node_modules/highcharts/highcharts.js
var require_highcharts = __commonJS({
  "node_modules/.pnpm/highcharts@9.3.3/node_modules/highcharts/highcharts.js"(exports, module) {
    (function(Z, M) {
      ...
      M(a, "Core/Utilities.js", [a["Core/Globals.js"]], function(a2) {
        ...
        function z(m, b2) {
          var d2 = {};
          B(m, function(D, x) {
            if (H(m[x], true) && !m.nodeType && b2[x]) D = z(m[x], b2[x]), Object.keys(D).length && (d2[x] = D);
            else if (H(m[x]) || m[x] !== b2[x]) d2[x] = m[x];
          });
          return d2;
        }
        function F(m, b2) {
        ...
        function c(b2, d2) {
          var m;
          b2 || (b2 = {});
          for (m in d2) b2[m] = d2[m];
          return b2;
        }
        function h() {
          for (var b2 = arguments, d2 = b2.length, x = 0; x < d2; x++) {
            var g2 = b2[x];
            if ("undefined" !== typeof g2 && null !== g2) return g2;
          }
        }
        function f(b2, d2) {
        ...
        function p(b2, d2, x) {
          var m = a2.getStyle || p;
          if ("width" === d2) return d2 = Math.min(b2.offsetWidth, b2.scrollWidth), x = b2.getBoundingClientRect && b2.getBoundingClientRect().width, x < d2 && x >= d2 - 1 && (d2 = Math.floor(x)), Math.max(0, d2 - (m(b2, "padding-left", true) || 0) - (m(b2, "padding-right", true) || 0));
          if ("height" === d2) return Math.max(0, Math.min(b2.offsetHeight, b2.scrollHeight) - (m(b2, "padding-top", true) || 0) - (m(b2, "padding-bottom", true) || 0));
        ...
        function B(b2, d2, g2) {
          for (var m in b2) Object.hasOwnProperty.call(b2, m) && d2.call(g2 || b2[m], b2[m], m, b2);
        }
        function t(b2, d2, g2) {
          function m(d3, m2) {
        ...
        function J(b2, d2, g2, l2) {
          ...
          if (r.createEvent && (b2.dispatchEvent || b2.fireEvent && b2 !== a2)) {
            ...
            m = [];
            for (var x = b2, D = false; x.hcEvents; ) Object.hasOwnProperty.call(x, "hcEvents") && x.hcEvents[d2] && (m.length && (D = true), m.unshift.apply(m, x.hcEvents[d2])), x = Object.getPrototypeOf(x);
        ...
        var b = Array.prototype.find ? function(b2, d2) {
          ...
          var m, g2 = b2.length;
          for (m = 0; m < g2; m++) if (d2(b2[m], m)) return b2[m];
        };
        ...
        l.jQuery && (l.jQuery.fn.highcharts = function() {
          ...
          if (this[0]) return b2[0] ? (new a2[y(b2[0]) ? b2.shift() : "Chart"](this[0], b2[0], b2[1]), this) : C[e(this[0], "data-highcharts-chart")];
        });
        b = { addEvent: function(b2, d2, g2, l2) {
          ...
          for (var d2 = b2.length, m = b2[0]; d2--; ) b2[d2] > m && (m = b2[d2]);
          return m;
          ...
          for (var m = b2.length; m--; ) if (b2[m] === d2) {
            b2.splice(m, 1);
            break;
          }
          ...
          for (b2 = b2.split("."); b2.length && k(d2); ) {
            ...
            d2 = d2[m];
            if (!k(d2) || "function" === typeof d2 || "number" === typeof d2.nodeType || d2 === l) return;
          }
          return d2;
          ...
          var c2 = d2.length;
          for (b2 = 0; b2 < c2; b2++) g2 = l2(g2, d2[b2]);
          return g2;
          ...
          for (l2 = 0; l2 < g2; l2++) b2[l2].safeI = l2;
          b2.sort(function(b3, g3) {
            m = d2(b3, g3);
            return 0 === m ? b3.safeI - g3.safeI : m;
          });
          for (l2 = 0; l2 < g2; l2++) delete b2[l2].safeI;
        }, syncTimeout: function(b2, d2, g2) {
          if (0 < d2) return setTimeout(b2, d2, g2);
          b2.call(0, g2);
          return -1;
        }, timeUnits: {
          millisecond: 1,
      ...
      M(a, "Core/Color/Color.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function(a2, u) {
        ...
        u = function() {
          function u2(v2) {
            ...
            this.input = v2;
            var A = a2.Color;
            if (A && A !== u2) return new A(v2);
            if (!(this instanceof u2)) return new u2(v2);
            this.init(v2);
          }
          ...
          u2.prototype.init = function(a3) {
            var A;
            if ("object" === typeof a3 && "undefined" !== typeof a3.stops) this.stops = a3.stops.map(function(e) {
              return new u2(e[1]);
            });
              ...
              if (!A) for (n = u2.parsers.length; n-- && !A; ) {
                var k = u2.parsers[n];
          ...
          u2.prototype.brighten = function(a3) {
            ...
            else if (v(a3) && 0 !== a3) for (var q = 0; 3 > q; q++) A[q] += y(255 * a3), 0 > A[q] && (A[q] = 0), 255 < A[q] && (A[q] = 255);
            return this;
          };
          ...
          u2.prototype.tweenTo = function(a3, A) {
            ...
            if (!v(q[0]) || !v(n[0])) return a3.input || "none";
            a3 = 1 !== n[3] || 1 !== q[3];
      ...
      M(a, "Core/Time.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function(a2, u) {
        ...
        u = function() {
          ...
          w.prototype.set = function(c2, e2, f2) {
            if (this.variableTimezone || this.timezoneOffset) {
              if ("Milliseconds" === c2 || "Seconds" === c2 || "Minutes" === c2 && 0 === this.getTimezoneOffset(e2) % 36e5) return e2["setUTC" + c2](f2);
          ...
          w.prototype.dateFormat = function(c2, e2, f2) {
            if (!F(e2) || isNaN(e2)) return a2.defaultOptions.lang && a2.defaultOptions.lang.invalidDate || "";
            c2 = k(c2, "%Y-%m-%d %H:%M:%S");
            ...
            q(h2, function(b2, d2) {
              for (; -1 !== c2.indexOf("%" + d2); ) c2 = c2.replace("%" + d2, "function" === typeof b2 ? b2.call(p, e2) : b2);
            });
          ...
          w.prototype.getTimeTicks = function(e2, h2, f2, w2) {
            ...
            if (F(h2)) {
              ...
              h2 = b.getTime();
              for (b = 1; h2 < f2; ) r.push(h2), h2 = g === c.year ? p.makeTime(D + b * d, 0) : g === c.month ? p.makeTime(D, w2 + b * d) : !m || g !== c.day && g !== c.week ? m && g === c.hour && 1 < d ? p.makeTime(D, w2, x, t + b * d) : h2 + g * d : p.makeTime(D, w2, x + b * d * (g === c.day ? 1 : 7)), b++;
              r.push(h2);
          ...
          w.prototype.getDateFormat = function(e2, h2, f2, w2) {
            ...
            if (b) var g = this.resolveDTLFormat(w2[b]).main;
            return g;
          };
          return w;
        }();
      ...
      M(a, "Core/DefaultOptions.js", [a["Core/Chart/ChartDefaults.js"], a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Color/Palettes.js"], a["Core/Time.js"], a["Core/Utilities.js"]], function(a2, u, z, F, y, G) {
        ...
        a2 = { defaultOptions: A, defaultTime: q, getOptions: function() {
          ...
          v(true, A, n);
          if (n.time || n.global) z.time ? z.time.update(v(
            A.global,
            A.time,
            n.global,
            n.time
      ...
      M(a, "Core/Animation/Fx.js", [a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Utilities.js"]], function(a2, u, z) {
        ...
        return function() {
          ...
          a3.prototype.dSetter = function() {
            ...
            a4 = a4 && a4[1];
            var k = this.now || 0, e = [];
            if (1 !== k && n && a4) if (n.length === a4.length && 1 > k) for (var c = 0; c < a4.length; c++) {
          ...
          a3.prototype.update = function() {
            ...
            else a4.attr ? a4.element && a4.attr(n, k, null, true) : a4.style[n] = k + this.unit;
            e && e.call(a4, k, this);
          };
          a3.prototype.run = function(q, n, k) {
            var e = this, c = e.options, h = function(c2) {
              ...
              for (var c2 = 0; c2 < a3.timers.length; c2++) a3.timers[c2]() || a3.timers.splice(c2--, 1);
          ...
          a3.prototype.step = function(a4) {
            ...
            if (e.attr && !e.element) a4 = false;
              ...
              w && c && c.call(e);
              a4 = false;
            } else this.pos = k.easing((n - this.startTime) / h), this.now = this.start + (this.end - this.start) * this.pos, this.update(), a4 = true;
            return a4;
          };
          a3.prototype.initPath = function(a4, n, k) {
            ...
            function c(c2, e2) {
              for (; c2.length < J; ) if (e2 = c2[Math.floor(c2.length / p) - 1].slice(), "C" === e2[0] && (e2[1] = e2[5], e2[2] = e2[6]), w) {
            ...
            if (!n) return [k, k];
            if (h && f && f.length) {
              for (a4 = 0; a4 < h.length; a4++) if (h[a4] === f[0]) {
                var B = a4;
                break;
      ...
      M(a, "Core/Animation/AnimationUtilities.js", [a["Core/Animation/Fx.js"], a["Core/Utilities.js"]], function(a2, u) {
        ...
        function F(c, e2) {
          for (var h = a2.timers.length; h--; ) a2.timers[h].elem !== c || e2 && e2 !== a2.timers[h].prop || (a2.timers[h].stopped = true);
        }
      ...
      M(a, "Core/Renderer/HTML/AST.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function(a2, u) {
        ...
        H = function() {
          ...
          h.prototype.parseMarkup = function(e2) {
            var h2 = [];
            e2 = e2.trim();
            if (c) e2 = new DOMParser().parseFromString(k ? k.createHTML(e2) : e2, "text/html");
            else {
              var p = y("div");
              p.innerHTML = e2;
              e2 = { body: p };
      ...
      M(a, "Core/Renderer/RendererUtilities.js", [a["Core/Utilities.js"]], function(a2) {
        ...
        (function(a3) {
          function u(a4, q, n) {
            ...
            for (f = a4.length; f--; ) B += a4[f].size;
            if (B > e) {
              F(a4, c);
              for (B = f = 0; B <= e; ) B += a4[f].size, f++;
            ...
            for (a4 = a4.map(function(c2) {
              ...
              for (f = a4.length; f--; ) e = a4[f], c = (Math.min.apply(0, e.targets) + Math.max.apply(0, e.targets)) / 2, e.pos = v(
                c - e.size * e.align,
                0,
                q - e.size
              );
              f = a4.length;
              for (w = false; f--; ) 0 < f && a4[f - 1].pos + a4[f - 1].size > a4[f].pos && (a4[f - 1].size += a4[f].size, a4[f - 1].targets = a4[f - 1].targets.concat(a4[f].targets), a4[f - 1].align = 0.5, a4[f - 1].pos + a4[f - 1].size > q && (a4[f - 1].pos = q - a4[f - 1].size), a4.splice(f, 1), w = true);
            }
            k.push.apply(k, p);
            f = 0;
            a4.some(function(c2) {
              ...
              return (c2.targets || []).some(function() {
                k[f].pos = c2.pos + e2;
                if ("undefined" !== typeof n && Math.abs(k[f].pos - k[f].target) > n) return k.slice(0, f + 1).forEach(function(c3) {
      ...
      M(a, "Core/Renderer/SVG/SVGElement.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Renderer/HTML/AST.js"], a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Utilities.js"]], function(a2, u, z, F, y) {
        ...
        a2 = function() {
          ...
          a3.prototype.add = function(b2) {
            ...
            this.added = true;
            if (!b2 || b2.handleZ || this.zIndex) var g2 = this.zIndexSetter();
          ...
          a3.prototype.align = function(b2, c2, g2) {
            ...
            if (b2) {
              if (this.alignOptions = b2, this.alignByTranslate = c2, !g2 || d(g2)) this.alignTo = l2 = g2 || "renderer", J(e2, this), e2.push(this), g2 = void 0;
          ...
          a3.prototype.css = function(b2) {
            ...
            if (l2) {
              ...
              if (b2) {
                ...
                else if ("text" === g2.nodeName.toLowerCase() && b2.width) var r2 = this.textWidth = I(b2.width);
              }
              this.styles = b2;
          ...
          a3.prototype.dashstyleSetter = function(b2) {
            ...
            if (b2 = b2 && b2.toLowerCase()) {
              ...
              for (b2 = c2.length; b2--; ) c2[b2] = "" + I(c2[b2]) * x(d2, NaN);
          ...
          a3.prototype.destroy = function() {
            ...
            if (b2.stops) {
              for (g2 = 0; g2 < b2.stops.length; g2++) b2.stops[g2].destroy();
              b2.stops.length = 0;
              b2.stops = void 0;
            }
            b2.safeRemoveChild(d2);
            for (c2.styledMode || b2.destroyShadows(); m2 && m2.div && 0 === m2.div.childNodes.length; ) d2 = m2.parentGroup, b2.safeRemoveChild(m2.div), delete m2.div, m2 = d2;
          ...
          a3.prototype.destroyTextPath = function(b2, d2) {
            ...
            if (c2) {
              if (c2.removeAttribute("dx"), c2.removeAttribute("dy"), d2.element.setAttribute("id", ""), this.textPathWrapper && c2.getElementsByTagName("textPath").length) {
                for (b2 = this.textPathWrapper.element.childNodes; b2.length; ) c2.appendChild(b2[0]);
          ...
          a3.prototype.getBBox = function(d2, c2) {
            ...
            if (!f2) {
              ...
              if (D2 && ("" === l2 || 0 < f2.height)) {
                for (; 250 < h2.length; ) delete r2[h2.shift()];
                r2[D2] || h2.push(D2);
                r2[D2] = f2;
              }
            }
          ...
          a3.prototype.setTextPath = function(b2, d2) {
            ...
            if (b2 && d2 && d2.enabled) {
              ...
              if (x2) for (e2.setAttribute("y", 0), g(E.dx) && e2.setAttribute("x", -E.dx), b2 = [].slice.call(e2.childNodes), x2 = 0; x2 < b2.length; x2++) {
                var f2 = b2[x2];
            ...
            } else r2 && (delete this.updateTransform, delete this.applyTextOutline, this.destroyTextPath(c2, b2), this.updateTransform(), this.options && this.options.rotation && this.applyTextOutline(this.options.style.textOutline));
            return this;
          };
          ...
          a3.prototype.strokeWidth = function() {
            ...
            if (b2.indexOf("px") === b2.length - 2) d2 = I(b2);
            else if ("" !== b2) {
          ...
          a3.prototype.updateShadows = function(b2, d2, c2) {
            var g2 = this.shadows;
            if (g2) for (var m2 = g2.length; m2--; ) c2.call(g2[m2], "height" === b2 ? Math.max(d2 - (g2[m2].cutHeight || 0), 0) : "d" === b2 ? this.d : d2, b2, g2[m2]);
          };
          ...
          a3.prototype.zIndexSetter = function(b2, d2) {
            ...
            if (l2) {
              ...
              for (E = d2.length - 1; 0 <= E && !a4; E--) {
                ...
                var r2 = !t(l2);
                if (g2 !== e2) {
                  if (0 > b2 && r2 && !c2 && !E) m2.insertBefore(e2, d2[E]), a4 = true;
                  else if (I(l2) <= b2 || r2 && (!t(b2) || 0 <= b2)) m2.insertBefore(e2, d2[E + 1] || null), a4 = true;
                }
              }
        ...
        function(a2, u) {
          var v = this && this.__extends || /* @__PURE__ */ function() {
            var a3 = function(k, e) {
              a3 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(c, e2) {
                ...
                for (var a4 in e2) e2.hasOwnProperty(a4) && (c[a4] = e2[a4]);
              };
              return a3(k, e);
            };
            return function(k, e) {
          ...
          return function(n) {
            ...
            k.prototype.updateTextPadding = function() {
              ...
              if (h !== a3.x || c !== a3.y) a3.attr("x", h), a3.hasBoxWidthChanged && (this.bBox = a3.getBBox(true)), "undefined" !== typeof c && a3.attr("y", c);
              a3.x = h;
              a3.y = c;
            };
        ...
        return function() {
          ...
          k.prototype.modifyDOM = function() {
            ...
            if (k2) {
              var p = function(e, p2) {
                ...
                if (a3.ellipsis) f2 && a3.truncate(e, f2, void 0, 0, Math.max(0, k2 - parseInt(a3.fontSize || 12, 10)), function(b2, d2) {
                  return b2.substring(
                    0,
                    d2
                  ) + "…";
                  ...
                  f2 = [];
                  for (l = []; p2.firstChild && p2.firstChild !== e; ) l.push(p2.firstChild), p2.removeChild(p2.firstChild);
                  for (; r.length; ) r.length && !a3.noWrap && 0 < g && (f2.push(e.textContent || ""), e.textContent = r.join(" ").replace(/- /g, "-")), a3.truncate(e, void 0, r, 0 === g ? d || 0 : 0, k2, function(b2, d2) {
          ...
          k.prototype.truncate = function(a3, c, h, f, k2, p) {
            var e = this.svgElement, t = e.renderer, w = e.rotation, n2 = [], r = h ? 1 : 0, l = (c || h || "").length, b = l, g, d = function(b2, d2) {
              ...
              if (g2 && "undefined" === typeof n2[d2]) if (g2.getSubStringLength) try {
                n2[d2] = f + g2.getSubStringLength(0, h ? d2 + 1 : d2);
              } catch (P) {
                "";
              }
              else t.getSpanWidth && (a3.textContent = p(c || h, b2), n2[d2] = f + t.getSpanWidth(e, a3));
              return n2[d2];
            };
            e.rotation = 0;
            var m = d(a3.textContent.length);
            if (f + m > k2) {
              for (; r <= l; ) b = Math.ceil((r + l) / 2), h && (g = p(h, b)), m = d(b, g && g.length - 1), r === l ? r = l + 1 : m > k2 ? l = b - 1 : r = b;
      ...
      M(a, "Core/Renderer/SVG/SVGRenderer.js", [a["Core/Renderer/HTML/AST.js"], a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Renderer/RendererRegistry.js"], a["Core/Renderer/SVG/SVGElement.js"], a["Core/Renderer/SVG/SVGLabel.js"], a["Core/Renderer/SVG/Symbols.js"], a["Core/Renderer/SVG/TextBuilder.js"], a["Core/Utilities.js"]], function(a2, u, z, F, y, G, H, A, q) {
        ...
        z = function() {
          ...
          L.prototype.symbol = function(a3, c2, g2, m2, L2, E) {
            ...
            if (D2) {
              ...
              b(t2.imgwidth) && b(t2.imgheight) ? I2(t2) : (t2.attr({ width: 0, height: 0 }), r("img", { onload: function() {
                ...
                p2.imgCount--;
                if (!p2.imgCount && b2 && !b2.hasLoaded) b2.onload();
          ...
          L.prototype.text = function(d2, a3, c2, g2) {
            ...
            if (!g2 || this.forExport && !this.allowHTML) d2.xSetter = function(b2, d3, a4) {
              for (var c3 = a4.getElementsByTagName("tspan"), g3 = a4.getAttribute(d3), m3 = 0, e2; m3 < c3.length; m3++) e2 = c3[m3], e2.getAttribute(d3) === g3 && e2.setAttribute(d3, b2);
        ...
        var v = this && this.__extends || /* @__PURE__ */ function() {
          var a3 = function(c2, e2) {
            a3 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(a4, c3) {
              ...
              for (var e3 in c3) c3.hasOwnProperty(e3) && (a4[e3] = c3[e3]);
            };
            return a3(c2, e2);
          };
            ...
            if (this.added) {
              ...
              if ("SPAN" === e2.tagName) {
                ...
                if (d !== this.oldTextWidth) {
                  ...
                  else q(e2, { width: "", whiteSpace: b || "nowrap" }), x = e2.offsetWidth;
          ...
          var v = this && this.__extends || /* @__PURE__ */ function() {
            var a3 = function(k, e) {
              a3 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(a4, e2) {
                ...
                for (var c in e2) e2.hasOwnProperty(c) && (a4[c] = e2[c]);
              };
              return a3(k, e);
            };
            return function(k, e) {
            ...
            k.prototype.html = function(e, c, h) {
              ...
              n2 && (f.add = function(a3) {
                ...
                if (this.parentGroup = a3) {
                  var l = a3.div;
                  if (!l) {
                    for (; a3; ) e2.push(a3), a3 = a3.parentGroup;
          ...
          u = function() {
            ...
            f.prototype.addLabel = function() {
              ...
              if (e2.dateTime) if (g) {
                ...
                var v2 = P.main;
              } else k(J) && (v2 = e2.dateTime.getXDateFormat(J, f2.dateTimeLabelFormats || {}));
              c2.isFirst = d;
              c2.isLast = m;
              var O = {
                axis: e2,
              ...
              c2.shortenLabel = A2 ? function() {
                for (I = 0; I < A2.length; I++) if (q(O, { dateTimeLabelFormat: A2[I] }), x.attr({ text: u2.call(O, O) }), x.getBBox().width < e2.getSlotWidth(c2) - 2 * b.padding) return;
                x.attr({ text: "" });
              } : void 0;
            ...
            f.prototype.createLabel = function(a3, c2, h2) {
              ...
              if (a3 = H(c2) && h2.enabled ? p.renderer.text(c2, a3.x, a3.y, h2.useHTML).add(f2.labelGroup) : null) p.styledMode || a3.css(e(h2.style)), a3.textPxLength = a3.getBBox().width;
              return a3;
            };
            ...
            f.prototype.handleOverflow = function(a3) {
              ...
              if (b || "justify" !== e2.overflow) 0 > b && f2 - g * d < r ? w = Math.round(f2 / Math.cos(b * v) - r) : 0 < b && f2 + g * d > n2 && (w = Math.round((k2 - f2) / Math.cos(b * v)));
              else if (k2 = f2 + (1 - g) * d, f2 - g * d < r ? x = a3.x + x * (1 - g) - r : k2 > n2 && (x = n2 - a3.x + x * g, I = -1), x = Math.min(m, x), x < m && "center" === c2.labelAlign && (a3.x += I * (m - x - g * (m - Math.min(d, x)))), d > x || c2.autoRotation && (l.styles || {}).width) w = x;
            ...
            f.prototype.renderGridLine = function(a3, c2, e2) {
              ...
              if (d && (e2 = f2.getPlotLinePath({ value: r + b, lineWidth: d.strokeWidth() * e2, force: "pass", old: a3 }))) d[a3 || this.isNew ? "attr" : "animate"]({ d: e2, opacity: c2 });
            };
      ...
      M(a, "Core/Axis/Axis.js", [
        ...
        a2 = function() {
          ...
          a3.prototype.defaultLabelFormatter = function(b2) {
            ...
            if (d2.categories) var r2 = "" + this.value;
            else if (e2) r2 = c2.dateFormat(e2, a4);
            else if (h2 && 1e3 <= f2) for (; h2-- && "undefined" === typeof r2; ) d2 = Math.pow(m2, h2 + 1), f2 >= d2 && 0 === 10 * a4 % d2 && null !== l2[h2] && 0 !== a4 && (r2 = b2(a4 / d2, -1) + l2[h2]);
            ...
            r(this, "getSeriesExtremes", null, function() {
              ...
              b2.series.forEach(function(c2) {
                if (c2.visible || !d2.options.chart.ignoreHiddenSeries) {
                  ...
                  } else if (c2 = c2.applyExtremes(), g(c2.dataMin) && (l2 = c2.dataMin, b2.dataMin = Math.min(I(b2.dataMin, l2), l2)), g(c2.dataMax) && (f2 = c2.dataMax, b2.dataMax = Math.max(I(b2.dataMax, f2), f2)), p(m2) && (b2.threshold = m2), !e2.softThreshold || b2.positiveValuesOnly) b2.softThreshold = false;
                }
              });
            });
          ...
          a3.prototype.getPlotLinePath = function(b2) {
            function d2(b3, d3, a5) {
              if ("pass" !== n2 && b3 < d3 || b3 > a5) n2 ? b3 = f(b3, d3, a5) : B2 = true;
              return b3;
            }
          ...
          a3.prototype.getMinorTickPositions = function() {
            ...
            if (g2 && g2 / a4 < this.len / 3) {
              ...
              if (l2) this.paddedTicks.forEach(function(b3, d3, c3) {
                d3 && m2.push.apply(
                  m2,
                  l2.getLogTickPositions(a4, c3[d3 - 1], c3[d3], true)
                );
              });
              else if (this.dateTime && "auto" === this.getMinorTickInterval()) m2 = m2.concat(this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(a4), e2, c2, b2.startOfWeek));
              else for (b2 = e2 + (d2[0] - e2) % a4; b2 <= c2 && b2 !== m2[0]; b2 += a4) m2.push(b2);
            }
          ...
          a3.prototype.adjustForMinRange = function() {
            ...
            this.isXAxis && "undefined" === typeof this.minRange && !d2 && (p(b2.min) || p(b2.max) || p(b2.floor) || p(b2.ceiling) ? this.minRange = null : (this.series.forEach(function(b3) {
              ...
              if (1 < f2.length) {
                for (m2 = r2; 0 < m2; m2--) if (l2 = f2[m2] - f2[m2 - 1], !g2 || l2 < g2) g2 = l2;
              }
          ...
          a3.prototype.updateNames = function() {
            ...
            0 < d2.length && (Object.keys(d2.keys).forEach(function(b3) {
              ...
              d3.xIncrement = null;
              if (!d3.points || d3.isDirtyData) b2.max = Math.max(b2.max, d3.xData.length - 1), d3.processData(), d3.generatePoints();
          ...
          a3.prototype.setAxisTranslation = function() {
            ...
            if (g2 || e2 || m2) {
              ...
              c2 ? (l2 = c2.minPointOffset, f2 = c2.pointRangePadding) : b2.series.forEach(function(a5) {
                ...
                m2 = Math.max(m2, c3);
                if (!b2.single || e2) a5 = a5.is("xrange") ? !g2 : g2, l2 = Math.max(l2, a5 && d(h3) ? 0 : c3 / 2), f2 = Math.max(f2, a5 && "on" === h3 ? 0 : c3);
              });
          ...
          a3.prototype.trimTicks = function(b2, d2, a4) {
            ...
            r(this, "trimTicks");
            if (!this.isLinked) {
              if (d2 && -Infinity !== c2) this.min = c2;
              else for (; this.min - g2 > b2[0]; ) b2.shift();
              if (a4) this.max = e2;
              else for (; this.max + g2 < b2[b2.length - 1]; ) b2.pop();
          ...
          a3.prototype.adjustTickAmount = function() {
            ...
            if (this.hasData() && g(this.min) && g(this.max)) {
              if (m2 < c2) {
                for (; a4.length < c2; ) a4.length % 2 || this.min === l2 ? a4.push(w(a4[a4.length - 1] + d2)) : a4.unshift(w(a4[0] - d2));
              ...
              } else m2 > c2 && (this.tickInterval *= 2, this.setTickPositions());
              if (p(e2)) {
                for (d2 = b2 = a4.length; d2--; ) (3 === e2 && 1 === d2 % 2 || 2 >= e2 && 0 < d2 && d2 < b2 - 1) && a4.splice(d2, 1);
          ...
          a3.prototype.zoom = function(b2, d2) {
            ...
            r(this, "zoom", b2, function(b3) {
              ...
              if (d3 !== a4.min || g3 !== a4.max) a4.allowZoomOutside || (p(c2) && (d3 < m2 && (d3 = m2), d3 > l2 && (d3 = l2)), p(e2) && (g3 < m2 && (g3 = m2), g3 > l2 && (g3 = l2))), a4.displayBtn = "undefined" !== typeof d3 || "undefined" !== typeof g3, a4.setExtremes(d3, g3, false, void 0, { trigger: "zoom" });
              b3.zoomed = true;
            });
            return b2.zoomed;
          };
          ...
          a3.prototype.unsquish = function() {
            ...
            if (d2) {
              if (!b2.staggerLines && !b2.step) if (g(m2)) var p2 = [m2];
              else c2 < b2.autoRotationLimit && (p2 = b2.autoRotation);
          ...
          a3.prototype.getSlotWidth = function(b2) {
            ...
            if (a4 && 2 > c2.step) return c2.rotation ? 0 : (this.staggerLines || 1) * this.len / e2;
            if (!a4) {
              b2 = c2.style.width;
              if (void 0 !== b2) return parseInt(String(b2), 10);
              if (m2) return m2 - d2.spacing[3];
            }
          ...
          a3.prototype.renderUnsquish = function() {
            ...
            if (this.autoRotation) D2 > h2 && D2 > k2.h ? r2.rotation = this.labelRotation : this.labelRotation = 0;
            else if (f2) {
              var p2 = h2;
              if (!x2) {
                var n2 = "clip";
                for (h2 = c2.length; !l2 && h2--; ) {
                  var I2 = c2[h2];
                  if (I2 = e2[I2].label) I2.styles && "ellipsis" === I2.styles.textOverflow ? I2.css({ textOverflow: "clip" }) : I2.textPxLength > f2 && I2.css({ width: f2 + "px" }), I2.getBBox().height > this.len / c2.length - (k2.h - k2.f) && (I2.specificTextOverflow = "ellipsis");
                }
              }
            }
          ...
          a3.prototype.renderTick = function(b2, d2, a4) {
            var c2 = this.ticks;
            if (!this.isLinked || b2 >= this.min && b2 <= this.max || this.grid && this.grid.isColumn) c2[b2] || (c2[b2] = new H(this, b2)), a4 && c2[b2].isNew && c2[b2].render(
              d2,
              true,
              -1
            ), c2[b2].render(d2);
          ...
          a3.prototype.render = function() {
            ...
            [f2, h2, k2].forEach(function(b3) {
              ...
              U(function() {
                for (var d3 = a5.length; d3--; ) b3[a5[d3]] && !b3[a5[d3]].isActive && (b3[a5[d3]].destroy(), delete b3[a5[d3]]);
          ...
          a3.prototype.destroy = function(b2) {
            ...
            if (a4) for (b2 = a4.length; b2--; ) a4[b2].destroy();
            "axisLine axisTitle axisGroup gridGroup labelGroup cross scrollbar".split(" ").forEach(function(b3) {
              d2[b3] && (d2[b3] = d2[b3].destroy());
            });
            for (var e2 in d2.plotLinesAndBandsGroups) d2.plotLinesAndBandsGroups[e2] = d2.plotLinesAndBandsGroups[e2].destroy();
            x(d2, function(b3, a5) {
          ...
          a3.prototype.remove = function(b2) {
            for (var d2 = this.chart, a4 = this.coll, c2 = this.series, e2 = c2.length; e2--; ) c2[e2] && c2[e2].remove(false);
            t(d2.axes, this);
            t(d2[a4], this);
        ...
        (function(a3) {
          ...
          var k = function() {
            ...
            a4.prototype.getLogTickPositions = function(a5, e, f, k2) {
              ...
              if (0.5 <= a5) a5 = Math.round(a5), q2 = c.getLinearTickPositions(a5, e, f);
              else if (0.08 <= a5) {
              ...
              } else e = this.lin2log(e), f = this.lin2log(f), a5 = k2 ? c.getMinorTickInterval() : n2.tickInterval, a5 = y("auto" === a5 ? null : a5, this.minorAutoInterval, n2.tickPixelInterval / (k2 ? 5 : 1) * (f - e) / ((k2 ? h / c.tickPositions.length : h) || 1)), a5 = F(a5, void 0, z(a5)), q2 = c.getLinearTickPositions(a5, e, f).map(this.log2lin), k2 || (this.minorAutoInterval = a5 / 5);
        ...
        (function(a3) {
          ...
          var q = function() {
            ...
            a4.prototype.removePlotBandOrLine = function(a5) {
              ...
              if (e) {
                for (var f = e.length; f--; ) e[f].id === a5 && e[f].destroy();
                [c.plotLines || [], h.plotLines || [], c.plotBands || [], h.plotBands || []].forEach(function(c2) {
                  for (f = c2.length; f--; ) (c2[f] || {}).id === a5 && v(c2, c2[f]);
                });
              }
            };
      ...
      M(a, "Core/Axis/PlotLineOrBand/PlotLineOrBand.js", [a["Core/Axis/PlotLineOrBand/PlotLineOrBandAxis.js"], a["Core/Utilities.js"]], function(a2, u) {
        ...
        u = function() {
          ...
          e.prototype.render = function() {
            ...
            if (x) x = e2.getPlotLinePath({
              value: m,
              lineWidth: D.strokeWidth(),
              acrossPanes: p.acrossPanes
            });
            else if (I) x = e2.getPlotBandPath(d, g, p);
            else return;
        ...
        a2 = function() {
          ...
          a3.prototype.getLabel = function() {
            var b = this, a4 = this.chart.styledMode, d = this.options, c2 = this.split && this.allowShared, l = "tooltip" + (e(d.className) ? " " + d.className : ""), f2 = d.style.pointerEvents || (!this.followPointer && d.stickOnContact ? "auto" : "none"), r2 = function() {
              ...
              if (!b.inContact && d2 && d2.onMouseOut) d2.onMouseOut();
          ...
          a3.prototype.getPosition = function(b, a4, d) {
            ...
            var q2 = !this.followPointer && J(d.ttBelow, !c2.inverted === p2), B2 = function(b2, a5, d2, c3, m, r3, h3) {
              ...
              m = m + x - D;
              if (q2 && E2) g[b2] = m;
              else if (!q2 && p3) g[b2] = n3;
              else if (p3) g[b2] = Math.min(h3 - c3, 0 > n3 - l ? n3 : n3 - l);
              else if (E2) g[b2] = Math.max(r3, m + l + d2 > a5 ? m : m + l);
              else return false;
          ...
          a3.prototype.refresh = function(b, a4) {
            ...
            if (c2.enabled) {
              ...
              if (false === r2) this.hide();
              else {
                if (this.split && this.allowShared) this.renderSplit(r2, e2);
                else {
                  var q2 = n2, B2 = t2;
          ...
          a3.prototype.updatePosition = function(b) {
            ...
            if (this.outside) {
              ...
              if (1 !== c2.scaleX || 1 !== c2.scaleY) k(this.container, { transform: "scale(" + c2.scaleX + ", " + c2.scaleY + ")" }), f2 *= c2.scaleX, b *= c2.scaleY;
              f2 += c2.left - l.x;
              b += c2.top - l.y;
            }
      ...
      M(a, "Core/Series/Point.js", [a["Core/Renderer/HTML/AST.js"], a["Core/Animation/AnimationUtilities.js"], a["Core/DefaultOptions.js"], a["Core/FormatUtilities.js"], a["Core/Utilities.js"]], function(a2, u, z, F, y) {
        ...
        u = function() {
          ...
          g.prototype.destroy = function() {
            function b2() {
              if (a3.graphic || a3.dataLabel || a3.dataLabels) l(a3), a3.destroyElements();
              for (h2 in a3) a3[h2] = null;
            }
            ...
            if (a3 === e2.hoverPoint) a3.onMouseOut();
          ...
          g.prototype.getNestedProperty = function(b2) {
            if (b2) return 0 === b2.indexOf("custom.") ? h(b2, this.options) : this[b2];
          };
          g.prototype.getZone = function() {
            var b2 = this.series, a3 = b2.zones;
            b2 = b2.zoneAxis || "y";
            var c2, e2 = 0;
            for (c2 = a3[e2]; this[b2] >= c2.value; ) c2 = a3[++e2];
          ...
          g.prototype.optionsToObject = function(b2) {
            ...
            if (p(b2) || null === b2) l2[c2[0]] = b2;
            else if (f(b2)) for (!d && b2.length > e2 && (a3 = typeof b2[0], "string" === a3 ? l2.name = b2[0] : "number" === a3 && (l2.x = b2[0]), r2++); h2 < e2; ) d && "undefined" === typeof b2[r2] || (0 < c2[h2].indexOf(".") ? g.prototype.setNestedProperty(l2, b2[r2], c2[h2]) : l2[c2[h2]] = b2[r2]), r2++, h2++;
            else "object" === typeof b2 && (l2 = b2, b2.dataLabels && (a3._hasPointLabels = true), b2.marker && (a3._hasPointMarkers = true));
            return l2;
          };
          g.prototype.resolveColor = function() {
            ...
            } else a3 || (e2 = b2.color), a3 = b2.colorIndex;
          ...
          g.prototype.tooltipFormatter = function(b2) {
            ...
            (a3.pointArrayMap || ["y"]).forEach(function(a4) {
              a4 = "{point." + a4;
              if (e2 || g2) b2 = b2.replace(RegExp(a4 + "}", "g"), e2 + a4 + "}" + g2);
            ...
            if (!(b2 === this.state && !g2 || this.selected && "select" !== b2 || false === m.enabled || b2 && (k2 || r2 && false === h2.enabled) || b2 && n2.states && n2.states[b2] && false === n2.states[b2].enabled)) {
              ...
              if (this.graphic && !this.hasDummyGraphic) {
                ...
                if (b2 && h2) {
                  ...
                  if (B2) if (v2) v2[g2 ? "animate" : "attr"]({ x: B2.x, y: B2.y });
                  else l2 && (d.stateMarkerGraphic = v2 = t2.renderer.symbol(l2, B2.x, B2.y, B2.width, B2.height).add(d.markerGroup), v2.currentSymbol = l2);
        ...
        a2 = function() {
          ...
          a3.prototype.drop = function(a4) {
            ...
            if (this.selectionMarker) {
              ...
              if (this.hasDragged || g) b.axes.forEach(function(b2) {
          ...
          a3.prototype.findNearestKDPoint = function(a4, c2, b) {
            ...
            e2 = e2.tooltip;
            if (d && e2 && e2.isStickyOnContact()) return d;
            var l;
            a4.forEach(function(a5) {
          ...
          a3.prototype.getPointFromEvent = function(a4) {
            a4 = a4.target;
            for (var c2; a4 && !c2; ) c2 = a4.point, a4 = a4.parentNode;
            return c2;
          };
          a3.prototype.onTrackerMouseOut = function(a4) {
            ...
            if (!(!c2 || !a4 || c2.stickyTracking || this.inClass(a4, "highcharts-tooltip") || this.inClass(a4, "highcharts-series-" + c2.index) && this.inClass(a4, "highcharts-tracker"))) c2.onMouseOut();
          };
          a3.prototype.inClass = function(a4, c2) {
            for (var b; a4; ) {
              if (b = q(a4, "class")) {
                if (-1 !== b.indexOf(c2)) return true;
                if (-1 !== b.indexOf("highcharts-container")) return false;
              }
              a4 = a4.parentNode;
            }
          };
          ...
          a3.prototype.onContainerMouseDown = function(a4) {
            ...
            a4 = this.normalize(a4);
            if (u.isFirefox && 0 !== a4.button) this.onContainerMouseMove(a4);
            if ("undefined" === typeof a4.button || c2) this.zoomOption(a4), c2 && a4.preventDefault && a4.preventDefault(), this.dragStart(a4);
          };
          ...
          a3.prototype.onContainerTouchMove = function(a4) {
            if (this.touchSelect(a4)) this.onContainerMouseMove(a4);
            else this.touch(a4);
          };
          a3.prototype.onContainerTouchStart = function(a4) {
            if (this.touchSelect(a4)) this.onContainerMouseDown(a4);
            else this.zoomOption(a4), this.touch(a4, true);
          };
          ...
          a3.prototype.pinchTranslateDirection = function(a4, c2, b, e2, d, m, f2, h2) {
            ...
            if (b < x.min) {
              b = x.min;
              var J2 = true;
            } else b + w2 > x.max && (b = x.max - w2, J2 = true);
          ...
          a3.prototype.reset = function(a4, c2) {
            ...
            if (a4) f2 && l && J(l).length && (f2.refresh(l), f2.shared && m ? m.forEach(function(b2) {
          ...
          a3.prototype.runPointActions = function(e2, f2) {
            ...
            } else f2 && g && !g.isHidden && (m = g.getAnchor([{}], e2), b.isInsidePlot(m[0], m[1], { visiblePlotOnly: true }) && g.updatePosition({ plotX: m[0], plotY: m[1] }));
            this.unDocMouseMove || (this.unDocMouseMove = A(b.container.ownerDocument, "mousemove", function(b2) {
              var d2 = G[a3.hoverChartIndex];
              if (d2) d2.pointer.onDocumentMouseMove(b2);
          ...
          a3.prototype.setHoverChartIndex = function() {
            ...
            if (e2 && e2 !== c2) e2.pointer.onContainerMouseLeave({ relatedTarget: true });
            e2 && e2.mouseIsDown || (a3.hoverChartIndex = c2.index);
          };
          a3.prototype.touch = function(a4, c2) {
            var b = this.chart, e2;
            this.setHoverChartIndex();
            if (1 === a4.touches.length) if (a4 = this.normalize(a4), (e2 = b.isInsidePlot(a4.chartX - b.plotLeft, a4.chartY - b.plotTop, { visiblePlotOnly: true })) && !b.openMenu) {
            ...
            else 2 === a4.touches.length && this.pinch(a4);
          };
        ...
        G = function() {
          ...
          a3.prototype.handleOverflow = function(b2) {
            ...
            b2 && 0 < g && b2 > g && false !== k2.enabled ? (this.clipHeight = E = Math.max(g - 20 - this.titleHeight - h2, 0), this.currentPage = C(this.currentPage, 1), this.fullHeight = b2, t2.forEach(function(b3, a5) {
              ...
              if (!e3 || c3 - r2[e3 - 1] > E && (B2 || c3) !== r2[e3 - 1]) r2.push(B2 || c3), e3++;
              b3.pageIx = e3 - 1;
      ...
      M(a, "Core/Chart/Chart.js", [
        ...
        a2 = function() {
          ...
          a3.prototype.orderSeries = function(b2) {
            var a4 = this.series;
            b2 = b2 || 0;
            for (var c2 = a4.length; b2 < c2; ++b2) a4[b2] && (a4[b2].index = b2, a4[b2].name = a4[b2].getName());
          };
          ...
          a3.prototype.redraw = function(b2) {
            ...
            if (E2) for (b2 = c2.length; b2--; ) p2 = c2[b2], p2.options.stacking && (p2.isDirty = true);
            c2.forEach(function(b3) {
          ...
          a3.prototype.get = function(b2) {
            ...
            for (var c2 = this.series, d2 = da(this.axes, a4) || da(this.series, a4), e2 = 0; !d2 && e2 < c2.length; e2++) d2 = da(c2[e2].points || [], a4);
            return d2;
          };
          ...
          a3.prototype.temporaryDisplay = function(b2) {
            ...
            if (b2) for (; a4 && a4.style; ) a4.hcOrigStyle && (O(a4, a4.hcOrigStyle), delete a4.hcOrigStyle), a4.hcOrigDetached && (r.body.removeChild(a4), a4.hcOrigDetached = false), a4 = a4.parentNode;
            else for (; a4 && a4.style; ) {
              r.body.contains(a4) || a4.parentNode || (a4.hcOrigDetached = true, r.body.appendChild(a4));
              if ("none" === ea(a4, "display", false) || a4.hcOricDetached) a4.hcOrigStyle = { display: a4.style.display, height: a4.style.height, overflow: a4.style.overflow }, b2 = { display: "block", overflow: "hidden" }, a4 !== this.renderTo && (b2.height = 0), O(a4, b2), a4.offsetWidth || a4.style.setProperty("display", "block", "important");
              a4 = a4.parentNode;
              if (a4 === r.body) break;
            }
          };
          ...
          a3.prototype.getContainer = function() {
            ...
            if (this.styledMode) for (var m2 in a4.defs) this.renderer.definition(a4.defs[m2]);
          ...
          a3.prototype.reflow = function(b2) {
            ...
            if (!e2 && !a4.isPrinting && f2 && c2 && (d2 === g || d2 === r)) {
              if (f2 !== a4.containerWidth || c2 !== a4.containerHeight) h.clearTimeout(a4.reflowTimeout), a4.reflowTimeout = ba(function() {
          ...
          a3.prototype.drawChartBox = function() {
            ...
            if (e2) var x2 = B2 = q2.strokeWidth();
            else {
              x2 = b2.borderWidth || 0;
              B2 = x2 + (b2.shadow ? 8 : 0);
              f2 = { fill: f2 || "none" };
              if (x2 || q2["stroke-width"]) f2.stroke = b2.borderColor, f2["stroke-width"] = x2;
          ...
          a3.prototype.propFromSeries = function() {
            ...
            ["inverted", "angular", "polar"].forEach(function(f2) {
              ...
              for (d2 = c2 && c2.length; !g2 && d2--; ) (e2 = D[c2[d2].type]) && e2.prototype[f2] && (g2 = true);
              b2[f2] = g2;
            });
          };
          ...
          a3.prototype.render = function() {
            ...
            if (h2 || l2) b2.forEach(function(b3) {
          ...
          a3.prototype.destroy = function() {
            ...
            ia(b2);
            for (g2 = a4.length; g2--; ) a4[g2] = a4[g2].destroy();
          ...
          a3.prototype.update = function(b2, a4, d2, e2) {
            ...
            X(b2, function(a5, c2) {
              if (g2[c2] && "function" === typeof g2[c2].update) g2[c2].update(a5, false);
              else if ("function" === typeof g2[f2[c2]]) g2[f2[c2]](a5);
              else "colors" !== c2 && -1 === g2.collectionsWithUpdate.indexOf(c2) && W(true, g2.options[c2], b2[c2]);
          ...
          a3.prototype.zoom = function(b2) {
            ...
            !b2 || b2.resetSelection ? (a4.axes.forEach(function(b3) {
              ...
              if (!k2 && d2 >= h2 && d2 <= l2 || k2 || !U(d2)) m2 = true;
      ...
      M(a, "Core/Series/Series.js", [
        ...
        a2 = function() {
          ...
          a3.prototype.init = function(a4, b2) {
            ...
            h(this, b2);
            var e2 = b2.events;
            if (e2 && e2.click || b2.point && b2.point.events && b2.point.events.click || b2.allowPointSelect) a4.runTrackerClick = true;
            c2.getColor();
            c2.getSymbol();
          ...
          a3.prototype.insert = function(a4) {
            ...
            if (O(b2)) {
              for (c2 = a4.length; c2--; ) if (b2 >= K(a4[c2].options.index, a4[c2]._i)) {
            ...
            I(this, "bindAxes", null, function() {
              (a4.axisTypes || []).forEach(function(e2) {
                ...
                c2[e2].forEach(function(c3) {
                  d2 = c3.options;
                  if (b2[e2] === g2 && !d2.isInternal || "undefined" !== typeof b2[e2] && b2[e2] === d2.id || "undefined" === typeof b2[e2] && 0 === d2.index) a4.insert(c3.series), a4[e2] = c3, c3.isDirty = true;
                  d2.isInternal || g2++;
                });
          ...
          a3.prototype.findPointIndex = function(a4, b2) {
            ...
            if (c2) g2 = this.chart.get(c2), g2 instanceof G && (f2 = g2);
          ...
          a3.prototype.updateData = function(a4, b2) {
            ...
            a4.forEach(function(a5, b3) {
              ...
              if (m3.id || O(n3)) {
                if (m3 = this.findPointIndex(m3, p2), -1 === m3 || "undefined" === typeof m3 ? f2.push(a5) : e2[m3] && a5 !== c2.data[m3] ? (e2[m3].update(a5, false, null, false), e2[m3].touched = true, h2 && (p2 = m3 + 1)) : e2[m3] && (e2[m3].touched = true), !l2 || b3 !== m3 || d2 && d2.enabled || this.hasDerivedData) k2 = true;
              } else f2.push(a5);
            }, this);
            if (k2) for (a4 = e2.length; a4--; ) (m2 = e2[a4]) && !m2.touched && m2.remove && m2.remove(false, b2);
            else !l2 || d2 && d2.enabled ? n2 = false : (a4.forEach(function(a5, b3) {
          ...
          a3.prototype.setData = function(a4, b2, c2, d2) {
            ...
            if (!w2) {
              ...
              if (n2 && v2 > n2) if (x2 = e2.getFirstValidPoint(a4), O(x2)) for (c2 = 0; c2 < v2; c2++) r2[c2] = this.autoIncrement(), E[c2] = a4[c2];
              else if (S(x2)) if (t2) if (x2.length === t2) for (c2 = 0; c2 < v2; c2++) r2[c2] = this.autoIncrement(), E[c2] = a4[c2];
              else for (c2 = 0; c2 < v2; c2++) d2 = a4[c2], r2[c2] = d2[0], E[c2] = d2.slice(
                1,
                t2 + 1
              );
              else if (q2 && (B2 = q2.indexOf("x"), C2 = q2.indexOf("y"), B2 = 0 <= B2 ? B2 : 0, C2 = 0 <= C2 ? C2 : 1), 1 === x2.length && (C2 = 0), B2 === C2) for (c2 = 0; c2 < v2; c2++) r2[c2] = this.autoIncrement(), E[c2] = a4[c2][C2];
              else for (c2 = 0; c2 < v2; c2++) d2 = a4[c2], r2[c2] = d2[B2], E[c2] = d2[C2];
              else m(12, false, l2);
              else for (c2 = 0; c2 < v2; c2++) "undefined" !== typeof a4[c2] && (d2 = { series: e2 }, e2.pointClass.prototype.applyOptions.apply(d2, [a4[c2]]), e2.updateParallelArrays(d2, c2));
              E && U(E[0]) && m(14, true, l2);
              e2.data = [];
              e2.options.data = e2.userOptions.data = a4;
              for (c2 = f2; c2--; ) g2[c2] && g2[c2].destroy && g2[c2].destroy();
          ...
          a3.prototype.getProcessedData = function(a4) {
            ...
            for (d2 = h2.length || 1; --d2; ) if (b2 = c2 ? a4(h2[d2]) - a4(h2[d2 - 1]) : h2[d2] - h2[d2 - 1], 0 < b2 && ("undefined" === typeof q2 || b2 < q2)) var q2 = b2;
            else 0 > b2 && k2 && !p2 && (m(15, false, this.chart), k2 = false);
            return { xData: h2, yData: l2, cropped: t2, cropStart: f2, closestPointRange: q2 };
          };
          a3.prototype.processData = function(a4) {
            var b2 = this.xAxis;
            if (this.isCartesian && !this.isDirty && !b2.isDirty && !this.yAxis.isDirty && !a4) return false;
          ...
          a3.prototype.cropData = function(a4, b2, c2, d2, e2) {
            ...
            for (f2 = 0; f2 < g2; f2++) if (a4[f2] >= c2) {
              h2 = Math.max(0, f2 - e2);
              break;
            }
            for (c2 = f2; c2 < g2; c2++) if (a4[c2] > d2) {
              l2 = c2 + e2;
              break;
            }
          ...
          a3.prototype.generatePoints = function() {
            ...
            for (p2 = 0; p2 < g2; p2++) {
              ...
              } else (t2 = n2[r2]) || "undefined" === typeof b2[r2] || (n2[r2] = t2 = new e2().init(this, b2[r2], c2[p2]));
              t2 && (t2.index = h2 ? a4 + p2 : r2, k2[p2] = t2);
            }
            this.options.keys = l2;
            if (n2 && (g2 !== (m2 = n2.length) || h2)) for (p2 = 0; p2 < m2; p2++) p2 !== f2 || h2 || (p2 += g2), n2[p2] && (n2[p2].destroyElements(), n2[p2].plotX = void 0);
            this.data = n2;
            this.points = k2;
          ...
          a3.prototype.getExtremes = function(a4, b2) {
            ...
            for (h2 = 0; h2 < p2; h2++) {
              ...
              if (t2 && r2) if (t2 = n2.length) for (; t2--; ) O(n2[t2]) && (g2[m2++] = n2[t2]);
              else g2[m2++] = n2;
            }
          ...
          a3.prototype.getFirstValidPoint = function(a4) {
            for (var b2 = a4.length, c2 = 0, d2 = null; null === d2 && c2 < b2; ) d2 = a4[c2], c2++;
            return d2;
          };
          a3.prototype.translate = function() {
            ...
            for (w2 = 0; w2 < k2; w2++) {
              ...
              if (h2.positiveValuesOnly && !h2.validatePositiveValue(J) || d2.positiveValuesOnly && !d2.validatePositiveValue(v2)) x2.isNull = true;
          ...
          a3.prototype.animate = function(a4) {
            ...
            if (a4 && c2) g2 = this.getClipBox(), h2 ? h2.attr("height", g2.height) : (g2.width = 0, e2 && (g2.x = b2.plotHeight), h2 = b2.renderer.clipRect(g2), b2.sharedClips[f2] = h2, l2 = b2.renderer.clipRect({ x: e2 ? (b2.plotSizeX || 0) + 99 : -99, y: e2 ? -b2.plotLeft : -b2.plotTop, width: 99, height: e2 ? b2.chartWidth : b2.chartHeight }), b2.sharedClips[f2 + "m"] = l2), c2.clip(h2), d2 && d2.clip(l2);
          ...
          a3.prototype.drawPoints = function() {
            ...
            if (false !== c2.enabled || this._hasPointMarkers) for (f2 = 0; f2 < a4.length; f2++) {
              var l2 = a4[f2];
              ...
              if ((g2 && "undefined" === typeof m2.enabled || m2.enabled) && !l2.isNull && false !== l2.visible) {
                ...
                if (h2 && !b2.styledMode) h2[k2](this.pointAttribs(l2, l2.selected && "select"));
                h2 && h2.addClass(l2.getClassName(), true);
              } else h2 && (l2.graphic = h2.destroy());
            }
          };
          ...
          a3.prototype.destroy = function(a4) {
            ...
            for (h2 = g2.length; h2--; ) (l2 = g2[h2]) && l2.destroy && l2.destroy();
          ...
          a3.prototype.applyZones = function() {
            ...
            if (d2.length && (g2 || f2) && l2 && "undefined" !== typeof l2.min) {
              ...
              this.clips = e2;
            } else a4.visible && (g2 && g2.show(true), f2 && f2.show(true));
          };
          ...
          a3.prototype.drawTracker = function() {
            var a4 = this, b2 = a4.options, c2 = b2.trackByArea, d2 = [].concat(c2 ? a4.areaPath : a4.graphPath), e2 = a4.chart, g2 = e2.pointer, h2 = e2.renderer, l2 = e2.options.tooltip.snap, m2 = a4.tracker, k2 = function(b3) {
              if (e2.hoverSeries !== a4) a4.onMouseOver();
            ...
            m2 ? m2.attr({ d: d2 }) : a4.graph && (a4.tracker = h2.path(d2).attr({ visibility: a4.visible ? "visible" : "hidden", zIndex: 2 }).addClass(c2 ? "highcharts-tracker-area" : "highcharts-tracker-line").add(a4.group), e2.styledMode || a4.tracker.attr({ "stroke-linecap": "round", "stroke-linejoin": "round", stroke: p2, fill: c2 ? p2 : "none", "stroke-width": a4.graph.strokeWidth() + (c2 ? 0 : 2 * l2) }), [a4.tracker, a4.markerGroup, a4.dataLabelsGroup].forEach(function(a5) {
              ...
              }), b2.cursor && !e2.styledMode && a5.css({ cursor: b2.cursor }), f)) a5.on("touchstart", k2);
            }));
          ...
          a3.prototype.addPoint = function(a4, b2, c2, d2, e2) {
            ...
            var r2 = n2.x;
            var t2 = k2.length;
            if (this.requireSorting && r2 < k2[t2 - 1]) for (p2 = true; t2 && k2[t2 - 1] > r2; ) t2--;
          ...
          a3.prototype.update = function(a4, b2) {
            ...
            f2 = false;
            if (B[t2]) {
              if (f2 = t2 !== c2.type, c2.remove(false, false, false, true), f2) if (Object.setPrototypeOf) Object.setPrototypeOf(c2, B[t2].prototype);
              else {
                k2 = Object.hasOwnProperty.call(c2, "hcEvents") && c2.hcEvents;
                for (n2 in h2) c2[n2] = void 0;
                D(c2, B[t2].prototype);
                k2 ? c2.hcEvents = k2 : delete c2.hcEvents;
              }
            } else m(17, true, d2, { missingModuleFor: t2 });
            r2.forEach(function(a5) {
              c2[a5] = r2[a5];
            });
            c2.init(d2, a4);
          ...
          a3.prototype.setState = function(a4, b2) {
            ...
            if (c2.state !== a4 && ([c2.group, c2.markerGroup, c2.dataLabelsGroup].forEach(function(b3) {
              ...
              if (f2[a4] && false === f2[a4].enabled) return;
              a4 && (l2 = f2[a4].lineWidth || l2 + (f2[a4].lineWidthPlus || 0), m2 = K(f2[a4].opacity, m2));
              if (e2 && !e2.dashstyle) for (d2 = { "stroke-width": l2 }, e2.animate(d2, h2); c2["zone-graph-" + k2]; ) c2["zone-graph-" + k2].animate(d2, h2), k2 += 1;
      ...
      M(a, "Extensions/ScrollablePlotArea.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Axis/Axis.js"], a["Core/Chart/Chart.js"], a["Core/Series/Series.js"], a["Core/Renderer/RendererRegistry.js"], a["Core/Utilities.js"]], function(a2, u, z, F, y, G) {
        ...
        A(z, "afterSetChartSize", function(a3) {
          ...
          if (!this.renderer.forExport) {
            ...
            } else c && (this.scrollablePixelsY = e = Math.max(
              0,
              c - this.chartHeight
        ...
        z.prototype.applyFixed = function() {
          ...
          if (this.scrollableDirty || a3) this.scrollableDirty = false, this.moveFixedElements();
          ...
          var f = function() {
            ...
            a4.prototype.buildStacks = function() {
              ...
              if (!a5.isXAxis) {
                ...
                for (h2 = 0; h2 < f2; h2++) c2[h2].modifyStacks();
                H(a5, "afterBuildStacks");
              }
            };
            a4.prototype.cleanStacks = function() {
              if (!this.axis.isXAxis) {
                if (this.oldStacks) var a5 = this.stacks = this.oldStacks;
                q(a5, function(a6) {
                  q(a6, function(a7) {
      ...
      M(a, "Extensions/Stacking.js", [a["Core/Axis/Axis.js"], a["Core/Chart/Chart.js"], a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/Series/Series.js"], a["Core/Axis/StackingAxis.js"], a["Core/Utilities.js"]], function(a2, u, z, F, y, G, H) {
        ...
        y.prototype.modifyStacks = function() {
          ...
          a3[k2 + "Stacker"] && [c2, "-" + c2].forEach(function(c3) {
            for (var b = f2.length, g, d; b--; ) if (g = f2[b], h2 = a3.getStackIndicator(h2, g, a3.index, c3), d = (g = e2[c3] && e2[c3][g]) && g.points[h2.key]) a3[k2 + "Stacker"](d, g, b);
          });
        };
        ...
        var v = this && this.__extends || /* @__PURE__ */ function() {
          var a3 = function(v2, q) {
            a3 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(a4, k) {
              ...
              for (var e in k) k.hasOwnProperty(e) && (a4[e] = k[e]);
            };
            return a3(v2, q);
          };
        ...
        var v = this && this.__extends || /* @__PURE__ */ function() {
          var a3 = function(e, c) {
            a3 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(a4, c2) {
              ...
              for (var e2 in c2) c2.hasOwnProperty(e2) && (a4[e2] = c2[e2]);
            };
            return a3(e, c);
          };
          return function(e, c) {
        ...
        F = function(a3) {
          ...
          e.prototype.getGraphPath = function(a4) {
            ...
            var g = function(c2, d2, e3) {
              ...
              if (e3 || f) {
                ...
                var n2 = c2[0] + e3;
                g2 = !!f;
              } else !k && a4[d2] && a4[d2].isNull && (h = n2 = l);
            ...
            for (q2 = 0; q2 < a4.length; q2++) {
              ...
              if (!d || e2) e2 || g(q2, q2 - 1, "left"), d && !k && e2 || (v2.push(a4[q2]), t.push({ x: q2, plotX: m, plotY: D })), e2 || g(q2, q2 + 1, "right");
            }
          ...
          e.prototype.getStackPoints = function(a4) {
            ...
            if (this.options.stacking) {
              for (var g = 0; g < a4.length; g++) a4[g].leftNull = a4[g].rightNull = void 0, u2[a4[g].x] = a4[g];
              q(t, function(a5, b2) {
              ...
              k.forEach(function(a5, g2) {
                var f = 0, h, m;
                if (u2[a5] && !u2[a5].isNull) e2.push(u2[a5]), [-1, 1].forEach(function(e3) {
                  var f2 = 1 === e3 ? "rightNull" : "leftNull", n2 = 0, p2 = t[k[g2 + e3]];
                  if (p2) for (var q3 = b; 0 <= q3 && q3 < r; ) {
                    var v3 = C[q3].index;
                    h = p2.points[v3];
      ...
      M(a, "Series/Column/ColumnSeries.js", [
        ...
        var v = this && this.__extends || /* @__PURE__ */ function() {
          var a3 = function(c2, b) {
            a3 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(a4, b2) {
              ...
              for (var c3 in b2) b2.hasOwnProperty(c3) && (a4[c3] = b2[c3]);
            };
            return a3(c2, b);
          };
        ...
        H = function(a3) {
          ...
          l.prototype.animate = function(a4) {
            ...
            if (a4) k2.scaleY = 1e-3, a4 = e(c2.toPixels(h2.threshold), c2.pos, c2.pos + c2.len), l2 ? k2.translateX = a4 - c2.len : k2.translateY = a4, b.clipBox && b.setClip(), b.group.attr(k2);
            else {
          ...
          l.prototype.drawPoints = function() {
            ...
            a4.points.forEach(function(b) {
              ...
              if (B(b.plotY) && null !== b.y) {
                ...
                if (g && l2) g[k2](t(h2));
                if (d.borderRadius) g[k2]({ r: d.borderRadius });
        ...
        (function(a3) {
          function f(a4, b, c2, d, f2) {
            ...
            if (w) {
              ...
              if (c2.shape && !r2) b[f2 ? "attr" : "animate"]({ anchorX: l ? h3.plotWidth - a4.plotY : a4.plotX, anchorY: l ? h3.plotHeight - a4.plotX : a4.plotY });
            }
          ...
          function z2(a4, b) {
            var c2 = [], d;
            if (q(a4) && !q(b)) c2 = a4.map(function(a5) {
              return n(a5, b);
            });
            else if (q(b) && !q(a4)) c2 = b.map(function(b2) {
              return n(a4, b2);
            });
            else if (q(a4) || q(b)) for (d = Math.max(a4.length, b.length); d--; ) c2[d] = n(a4[d], b[d]);
            else c2 = n(a4, b);
            return c2;
          }
        ...
        var v = this && this.__extends || /* @__PURE__ */ function() {
          var a3 = function(n, k) {
            a3 = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(a4, c) {
              ...
              for (var e in c) c.hasOwnProperty(e) && (a4[e] = c[e]);
            };
            return a3(n, k);
          };
          return function(n, k) {
      ...
      M(a, "Series/CenteredUtilities.js", [a["Core/Globals.js"], a["Core/Series/Series.js"], a["Core/Utilities.js"]], function(a2, u, z) {
        ...
        (function(a3) {
          a3.getCenter = function() {
            ...
            for (f = 0; 4 > f; ++f) p = a4[f], k = 2 > f || 2 === f && /%$/.test(p), a4[f] = H(p, [c, h, q, a4[2]][f]) + (k ? e : 0);
            a4[3] > a4[2] && (a4[3] = a4[2]);
            return a4;
          };
      ...
      M(a, "Series/Pie/PiePoint.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Series/Point.js"], a["Core/Utilities.js"]], function(a2, u, z) {
        ...
        a2(u.prototype, { connectorShapes: { fixedOffset: function(a3, e, c) {
          ...
          c = ["L", k, a3.y];
          f = true;
          if ("left" === h ? k > a3.x || k < e.x : k < a3.x || k > e.x) f = false;
          a3 = [["M", a3.x, a3.y]];
          f && a3.push(c);
          a3.push(["L", e.x, e.y]);
          return a3;
      ...
      M(a, "Series/Pie/PieSeries.js", [a["Series/CenteredUtilities.js"], a["Series/Column/ColumnSeries.js"], a["Core/Globals.js"], a["Core/Legend/LegendSymbol.js"], a["Series/Pie/PiePoint.js"], a["Core/Series/Series.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Renderer/SVG/Symbols.js"], a["Core/Utilities.js"]], function(a2, u, z, F, y, G, H, A, q) {
        ...
        q = function(a3) {
          ...
          c2.prototype.updateTotals = function() {
            ...
            this.total = b;
            for (f2 = 0; f2 < c3; f2++) g = a4[f2], g.percentage = 0 < b && (g.visible || !e2) ? g.y / b * 100 : 0, g.total = b;
          };
      ...
      M(a, "Series/Pie/PieDataLabel.js", [
        ...
        (function(f2) {
            ...
            a3.visible && (g.enabled || a3._hasPointLabels) && (f3.forEach(function(a4) {
              ...
              if (l) {
                ...
                for (X = 0; X < l; X++) {
                  ...
                  if (g.justify) N = B.justify(z2, u3, t2);
              ...
              if (F2 = c(R.connectorWidth, 1)) {
                ...
                if ((J = d2.dataLabel) && J._pos && d2.visible && 0 < d2.labelDistance) {
                  ...
                  if (f4 = !G) d2.connector = G = b.renderer.path().addClass("highcharts-data-label-connector  highcharts-color-" + d2.colorIndex + (d2.className ? " " + d2.className : "")).add(a3.dataLabelsGroup), b.styledMode || G.attr({ "stroke-width": F2, stroke: R.connectorColor || d2.color || "#666666" });
                  G[f4 ? "attr" : "animate"]({ d: d2.getConnectorPath() });
                  G.attr("visibility", W);
                } else G && (d2.connector = G.destroy());
              }
            }));
          }
          function u2() {
          ...
          function t(a3) {
            ...
            if (!f3) {
              if (null !== e2[0]) var k2 = Math.max(c2[2] - Math.max(a3[1], a3[3]), d);
              else k2 = Math.max(c2[2] - a3[1] - a3[3], d), c2[0] += (a3[3] - a3[1]) / 2;
      ...
      M(a, "Extensions/OverlappingDataLabels.js", [a["Core/Chart/Chart.js"], a["Core/Utilities.js"]], function(a2, u) {
        ...
        a2.prototype.hideOverlappingLabels = function(a3) {
          ...
          for (f = 0; f < e; f++) if (h = a3[f]) h.oldOpacity = h.opacity, h.newOpacity = 1, h.absoluteBox = q2(h);
            ...
            var e = function() {
              ...
              a4.prototype.currentOptions = function(a5) {
                function c2(a6, f2, h, k2) {
                  var b;
                  H(a6, function(a7, d) {
                    if (!k2 && -1 < e2.collectionsWithUpdate.indexOf(d) && f2[d]) for (a7 = q(a7), h[d] = [], b = 0; b < Math.max(a7.length, f2[d].length); b++) f2[d][b] && (void 0 === a7[b] ? h[d][b] = f2[d][b] : (h[d][b] = {}, c2(a7[b], f2[d][b], h[d][b], k2 + 1)));
                    else y(a7) ? (h[d] = F(a7) ? [] : {}, c2(a7, f2[d] || {}, h[d], k2 + 1)) : h[d] = "undefined" === typeof f2[d] ? null : f2[d];
                  });
                }
                var e2 = this, f = {};
...
//# sourceMappingURL=chunk-HAE5BWEV.js.map
